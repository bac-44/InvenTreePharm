...
const icons = {
  ...
  // Pharm Part Icons
  ndc: IconBarcode,
  acquistion_unit_cost: IconCash,
  hazardous: IconBiohazard,
  active_ingredient: IconFlask,
  flavored: IconCandy,
  consumable: IconDroplet,
  has_activity_factor: IconActivity,
  has_pack_stat: IconPackage,
  auxillary_labels: IconInfoCircle,
